...
el problema de [_prop drilling_](https://kentcdodds.com/blog/prop-drilling/)*1*. El hecho
...
and ["Colocation"](https://kentcdodds.com/blog/colocation). Y para más información de `context`,
lee
