...
After all, they both *seem* to serve the same purpose. So JavaScript lords (aka [TC-39](https://tc39.es/)), why bother in creating *yet* another concept to an already confusing language?
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Friendly reminder: don&#39;t misuse the nullish operator in <a href="https://twitter.com/hashtag/JavaScript?src=hash&amp;ref_src=twsrc%5Etfw">#JavaScript</a>, it&#39;s easy to think you can replace it for all cases in which you would normally use the OR sign. Remember, the nullish operator just checks for `null` or `undefined`!<a href="https://t.co/UwSbkk2HM0">pic.twitter.com/UwSbkk2HM0</a></p>&mdash; Julian Betancourt (@juliian41) <a href="https://twitter.com/juliian41/status/1337419064273211397?ref_src=twsrc%5Etfw">December 11, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

<!-- [https://twitter.com/juliian41/status/1337419064273211397?s=20](https://twitter.com/juliian41/status/1337419064273211397?s=20) -->